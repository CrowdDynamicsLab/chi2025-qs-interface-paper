...
% In the domain of CSCW and HCI, researchers have demonstrated how interactive design can effect the quality of participant responses. For example, the use of voice assistant as a form to elicit user feedback~\cite{xiaoLetMeAsk2021}. Recent work reminded how survey response formate can increase errors~\cite{pielotDidYouMisclick2024}
