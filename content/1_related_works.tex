...
We surveyed, to the best of our ability, using snowball sampling starting from acedemic journals and news events instances of QV and are publicaly available. Fig.~\ref{fig:qv_interface_external} contains two examples of these interfaces and a full list in Appendix XX. Existing interfaces share the same mechanism as QS, and identifying shared interface components. All QV interfaces generally include:
