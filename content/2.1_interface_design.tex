...
Existing interfaces consists standardized components shown in Figure~\ref{fig:qv_interface_external}~\footnote{Figure~\ref{fig:gov4gitInterface} did not exist until the writing of this paper.}. All interfaces shared these key components:
\begin{itemize}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \label{fig:qv_org_p2}
    \end{subfigure}
    \caption{Organize-then-Vote Prototype: Survey respondents first organize their thoughts into categories, then vote on the options.}
    \label{fig:qv_org}
\end{figure}
