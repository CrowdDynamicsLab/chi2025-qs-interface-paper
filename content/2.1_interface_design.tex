...
\subsection{QV interfaces in the wild}
Figure~\ref{fig:qv_interface_external} presents known QV interfaces~\footnote{Figure~\ref{fig:gov4gitInterface} did not exist until the writing of this paper.}. All interfaces shared these key components:
\begin{itemize}
