\begin{figure*}[ht!]
    ...
    \begin{subfigure}{0.83\textwidth} % Full width for the first subfigure
        \centering
    ...
    \begin{subfigure}{0.43\textwidth} % First subfigure on the second row
        \centering
    ...
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.43\textwidth} % Second subfigure on the second row
        \centering
