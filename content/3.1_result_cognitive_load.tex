...
\begin{itemize}
    ...
    \item Within short QS, the interactive interface trends to reduced cognitive load, with a posterior probability of $64.5\%$ supporting the reduction and a small-to-medium effect size ($d = 0.49$). Participants reported a median cognitive load of $29.85$ (mean = $35.36$, SD = $18.17$) under the two-phase interface compared to a median of $39.00$ (mean = $43.23$, SD = $17.65$) under the text interface.
    \item For the long QS, there trends a small increase in cognitive load with a posterior probability of $61.7\%$ and a small effect size ($d = 0.18$) The median cognitive load was $42.70$ (mean = $42.02$, SD = $18.48$) under the two-phase interface compared to $33.85$ (mean = $34.60$, SD = $17.69$) in the text interface.
\end{itemize}
...
These qualitative differences highlight the variation in~\textbf{levels of engagement} with the survey content. Participants using the two-phase interface, reported higher satisfactions qualitatively about their performance. These participants felt less rush in the short survey, and for the long survey, they considered broader aspects across different options and how to strategically allocate their credits. 