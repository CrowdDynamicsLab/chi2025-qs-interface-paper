...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{content/image/distance/cumulative_edit_distance_per_option_long_qs_v3v4.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{content/image/distance/slope_diff_and_effect_size.pdf}
    \caption{The figure shows the contrast distributions of slope differences in cumulative edit distance between the two-phase interface and text interface for long QSs. The left subplots show absolute differences, while the right depict effect sizes.~\textbf{Main takeaway:} Participants in the long text interface exhibited a steeper slope, indicating a faster increase in cumulative edit distance compared to the long two-phase interface.}
