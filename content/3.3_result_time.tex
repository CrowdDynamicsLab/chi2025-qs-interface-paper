...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth, trim=2 0 0 0, clip]{content/image/time/Total Time Per Option Across Different Interfaces.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth, trim=0 0 0 0, clip]{content/image/cog/Temporal_scores.pdf}
