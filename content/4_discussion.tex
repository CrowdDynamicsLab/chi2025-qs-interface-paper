...
In this section, we interpret the results related to cognitive load and survey respondent behaviors, emphasizing why the interactive interface did not uniformly reduce cognitive load in the long text interface while offering practical recommendations for practitioners deploying QS.

Our discussion centers on three key topics: elements of the two-phase interface that supported preference construction, design recommendations for practitioners, and future challenges. Ultimately, we conclude that the two-phase interface had differential effects on the short and long surveys. While trends suggest a reduction in cognitive load with the two-phase interface compared to the text interface, we observed evidence of deeper engagement with options and enhanced preference construction, particularly in the long survey condition.

\subsection{Result Interpretation}
\subsubsection{Deeper engagements through preference construction in two-phase interfaces}
Our main findings indicate that the survey results, qualitative data, and observed behavioral differences revealed shifts in the types of cognitive load experienced by participants, especially for those completing the long survey. Cognitive load theory~\cite{swellerCognitiveLoadTheory2011}, when applied to the context of QS, maps the three components of cognitive load: intrinsic load (the cognitive demand required to understand questions and response options), germane load (associated with deeper processing and evaluation of preferences), and extraneous load (stemming from navigating and operating the survey interface).

Participants were randomly assigned to experimental conditions, with both survey lengths containing options randomly drawn from a common pool to control intrinsic load within the same group.

In the short survey condition, participants engaged with all options simultaneously. The two-phase interface reduced some extraneous load associated with navigating the interface during voting, though it required participants to complete the grouping phase. Despite this additional task, participants across both interface types reported minimal or no physical demand. The two-phase interface likely facilitated easier engagement with preference construction due to its lower-trended cognitive load, as reflected in the increased likelihood of perceived lower cognitive load.

In the long survey condition, participants could not engage with all options simultaneously, resulting in a higher intrinsic load at the start of the survey. The organization phase in the two-phase interface shaped participant behavior during the voting phase. While it streamlined the process of locating options, as exemplified by the reduction of edit distance, this benefit may have been offset by the additional physical effort required to complete the grouping phase, as reflected by the slightly increased physical demand.

However, qualitative data regarding the voting task suggested that participants maintained their ability to invoke deeper engagement with options. Quantitative data revealed that participants made no fewer overall edits, with a bimodal distribution suggesting continued revision even at low budgets. Additionally, participants strategically considered broader options as they deliberated on nearby ones. These findings indicate a cognitive shift toward germane load, particularly during the voting phase.

In contrast, participants in the long text interface experienced higher extraneous load, evident in shallower reflection and shorter overall voting times, despite exhibiting a greater overall edit distance. While some might argue that the additional grouping phase offered participants more opportunities to familiarize themselves with the options, the long edit distance suggests that participants in the text interface traversed the list frequently, providing ample opportunity to adjust their preferences. Qualitative data indicated that 70\% of long text participants (N=7) scanned the list while voting, with edit distance data reflecting multiple passes across the list.

The deliberate one-option-at-a-time presentation during the voting task in the two-phase interface reduced reliance on defaults and encouraged deeper reflection. This is best illustrated by~\texttt{S013}, who emphasized how the organization phase supported their preference construction:
...
In addition, the observed lower overall cognitive load in the long text interface may partly reflect~\textit{satisficing behaviors}. Satisficing refers to participants settling for \textit{good enough} rather than\textit{optimal} decisions~\cite{gigerenzerReasoningFastFrugal1996} when unable to process all available information. Interviews revealed that 40\% of participants (N=4) in this condition described using satisficing strategies, while none from the long two-phase interface reported such behaviors. 

These strategies were exemplified by participants prioritizing minimal effort over thorough evaluation, as illustrated by:
...
This quote illustrates satisficing decision-making, where participants settle for suboptimal choices. Additional participants described similar strategies when deciding on votes:
...
These quotes highlight how participants in the long text interface adjusted to external constraints rather than carefully weighing internal preferences. This behavior suggests that cognitive overload may have led participants to adopt less effortful strategies. However, further research is needed to fully understand the prevalence and impact of satisficing in long QS surveys.

\textbf{In summary}, the two-phase interface likely reduced extraneous load, particularly in the long survey condition, facilitating a cognitive \textit{shift} toward deeper reflection and more deliberate decision-making. While the extent to which long QS surveys induce cognitive overload or satisficing remains unclear, the interactive interface shows promise in promoting deeper engagement with options and supporting comprehensive preference construction. The following section explores the specific elements that guided participants toward these outcomes.
...
This quote reflected participants' need to manually track and revisit options, which occupies extrannous load, without a more structured interface.

These evidences explain how the organization phase and the drag-and-drop features supported differentiation and consolidation, and scaffolded a decision-making framework that enables deeper engagement.
