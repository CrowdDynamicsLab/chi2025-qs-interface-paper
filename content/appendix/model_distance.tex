...
\begin{figure*}[h!]
    ...
    \caption{Differences in the variance of edit distance by version.~\textbf{The main takeaway: } This plot shows that with two-phase interface, there is a reduction in edit distance variance when the number of option grows.}
    \Description{
