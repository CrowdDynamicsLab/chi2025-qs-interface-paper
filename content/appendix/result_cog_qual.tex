...
\begin{table*}[p]
    ...
    \includegraphics[width=0.95\linewidth]{content/image/cog/physical_table.png}
\end{table*}
...
\begin{table*}[p]
    ...
    \includegraphics[width=0.9\linewidth]{content/image/cog/effort_table.png}
\end{table*}
\begin{table*}[p]
    ...
    \label{tbl:physical}
    \includegraphics[width=0.9\linewidth]{content/image/cog/perf_table.png}
\end{table*}
\begin{table*}[p]
